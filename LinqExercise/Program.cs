...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            numbers.Select((number, index) => index == 4 ? 32 : number).OrderByDescending(x => x).ToList().ForEach(x => Console.WriteLine(x));
            ...
            employees = employees.Append(new Employee("April", "Gilmer", 31, 0)).ToList();
